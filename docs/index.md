...
This documentation was built for azcam version 20.1.
...
### General
These commands are useful both in the server and in a console application.
...
### Server Classes
These are server-side only and are useed to define or control a system.
