...
from azcam.tools.observe.observe_qt.observe_gui_ui import Ui_observe
...
class ObserveQt(QMainWindow, ObserveCommon):
    ...
    def set_azalt(self, flag=1):
        ...
        if self.azalt_mode:
            ___qtablewidgetitem9.setText(QCoreApplication.translate("observe", u"AZ", None))
            ___qtablewidgetitem10.setText(QCoreApplication.translate("observe", u"ALT", None))
        else:
    ...
    def run_finished(self):
        ...
        # save pars
        # azcam.db.tools["parameters"].update_pars(1, "observe")
    ...
    def select_script(self):
        ...
        azcam.db.tools["parameters"].set_script_par("script_file", filename, "observe")
