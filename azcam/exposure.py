...
class ExposureConsole(ConsoleTools):
    ...
    def test(self, exposure_time: float = -1, shutter_state: int = 0) -> Optional[str]:
        ...
        return azcam.db.server.command(f"{self.objname}.test {exposure_time} {shutter_state}")
    ...
    def set_exposuretime(self, exposure_time: float) -> Optional[str]:
        ...
        return azcam.db.server.command(f"{self.objname}.set_exposuretime {exposure_time}")
    ...
    def get_image_title(self) -> str:
        ...
        return azcam.db.server.command(f"{self.objname}.get_image_title")
    ...
    def get_roi(self) -> List:
        ...
        return azcam.db.server.command(f"{self.objname}.get_roi")
