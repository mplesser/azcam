...
class Exposure(Objects, Filename, ObjectHeaderMethods):
    ...
    def sequence(self, number_exposures=1, flush_array_flag=-1, delay=-1):
        ...
        self.comp_sequence = self.check_comparison_imagetype() and azcam.db.instrument.enabled
    ...
    def get_exposuretime_remaining(self):
        ...
        if azcam.db.controller.is_reset:
            self.exposure_time_remaining = azcam.db.controller.update_exposuretime_remaining()
    ...
    def get_progress(self):
        """
        Return progress of exposure integration or readout.
        """
...
class ExposureConsole(ConsoleTools):
    ...
    def abort(self) -> None:
        ...
        try:
            azcam.db.server.rcommand(f"{self.objname}.abort")
        except Exception as e:
    ...
    def test(self, exposure_time: float = -1, shutter_state: int = 0) -> Optional[str]:
        ...
        return azcam.db.server.rcommand(f"{self.objname}.test {exposure_time} {shutter_state}")
    ...
    def integrate(self) -> None:
        ...
        return azcam.db.server.rcommand(f"{self.objname}.integrate")
    ...
    def readout(self) -> None:
        ...
        return azcam.db.server.rcommand(f"{self.objname}.readout")
    ...
    def end(self) -> None:
        ...
        return azcam.db.server.rcommand(f"{self.objname}.end")
    ...
    def guide(self, number_exposures: int = 1) -> Optional[str]:
        ...
        return azcam.db.server.rcommand(f"{self.objname}.guide {number_exposures}")
    ...
    def guide1(self, number_exposures: int = 1) -> Optional[str]:
        ...
        return azcam.db.server.rcommand(f"{self.objname}.guide1 {number_exposures}")
    ...
    def flush(self, cycles: int = 1) -> Optional[str]:
        ...
        return azcam.db.server.rcommand(f"{self.objname}.flush {cycles}")
    ...
    def start_readout(self):
        ...
        return azcam.db.server.rcommand(f"{self.objname}.start_readout")
    ...
    def get_image_types(self) -> List[str]:
        ...
        return azcam.db.server.rcommand(f"{self.objname}.get_image_types")
    ...
    def roi_reset(self) -> Optional[str]:
        ...
        return azcam.db.server.rcommand(f"{self.objname}.roi_reset")
    ...
    def get_exposuretime(self) -> Union[str, float]:
        ...
        reply = azcam.db.server.rcommand(f"{self.objname}.get_exposuretime")
    ...
    def get_exposuretime_remaining(self) -> Union[str, float]:
        ...
        reply = azcam.db.server.rcommand(f"{self.objname}.get_exposuretime_remaining")
    ...
    def set_exposuretime(self, exposure_time: float) -> Optional[str]:
        ...
        return azcam.db.server.rcommand(f"{self.objname}.set_exposuretime {exposure_time}")
    ...
    def get_pixels_remaining(self) -> Union[str, int]:
        ...
        reply = azcam.db.server.rcommand(f"{self.objname}.get_pixels_remaining")
    ...
    def parshift(self, number_rows: int) -> Optional[str]:
        ...
        return azcam.db.server.rcommand(f"{self.objname}.parshift {number_rows}")
    ...
    def pause_exposure(self) -> Optional[str]:
        ...
        return azcam.db.server.rcommand(f"{self.objname}.pause_exposure")
    ...
    def resume_exposure(self) -> Optional[str]:
        ...
        return azcam.db.server.rcommand(f"{self.objname}.resume_exposure")
    ...
    def get_filename(self) -> str:
        ...
        return azcam.db.server.rcommand(f"{self.objname}.get_filename")
    ...
    def set_image_filename(self, filename: str) -> Optional[str]:
        ...
        return azcam.db.server.rcommand(f"{self.objname}.set_filename {filename}")
    ...
    def get_image_title(self) -> str:
        ...
        return azcam.db.server.rcommand(f"{self.objname}.get_image_title")
    ...
    def set_image_title(self, title: str) -> Optional[str]:
        ...
        return azcam.db.server.rcommand(f"{self.objname}.set_image_title {title}")
    ...
    def get_roi(self) -> List:
        ...
        return azcam.db.server.rcommand(f"{self.objname}.get_roi")
    ...
    def get_focalplane(self) -> List:
        ...
        return azcam.db.server.rcommand(f"{self.objname}.get_focalplane")
    ...
    def get_format(self) -> List:
        ...
        return azcam.db.server.rcommand(f"{self.objname}.get_format")
