...
## Remote Imageserver - `azcam.tools.imageserver`
...
## Observing Scripts - `azcam.tools.observe`

These tools support running observing scripts. They can be used with a Qt-based GUI or with a 
...
This tools supports a fastapi-based web server.
...
These tools implements various browser-based tools.
